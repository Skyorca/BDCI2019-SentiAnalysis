...
train_label = pd.read_csv('./data/Train/Train_DataSet_Label.csv')['label']
pred_label = train_data.apply(mark)
print('Macro-F1={}'.format(f1_score(train_label,pred_label,average='weighted')))
print('accuracy={}'.format(accuracy_score(train_label,pred_label)))
